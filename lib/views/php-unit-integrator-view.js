...
export default class PhpUnitIntegratorView
{
    ...
    isCodeCoverageEnabled () {
        return this.refs.codeCoverageToggle.checked
    }
     ...
     */
    isDebugEnabled () {
        return this.refs.debugToggle.checked
    }
    ...
    disableButtons (disable) {
        return this.scheduleUpdate(() => {
            ...
            if (disable) {
                ...
                this.refs.debugToggle.setAttribute('disabled', true)
            } else {
                this.refs.codeCoverageToggle.removeAttribute('disabled')
                this.refs.debugToggle.removeAttribute('disabled')
            }
    ...
    onSelectSuites (suiteNames) {
        ...
        this.projectTester.setSelectedSuiteNames(project, suiteNames)
    }
    ...
    render () {
        ...
        const debugToggle = this.buildDebugToggle()
