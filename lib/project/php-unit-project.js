 ...
 *
 * @return {Promise}     - Resolves with a DOMDocument
 */
const readFile = (path) => {
...
export default class PhpUnitProject
{
   ...
   * @param {Emitter} [options.emitter]     - An optional event emitter
   * @param {string}  [options.phpPath]     - An optional path to the php binary
   * @param {string}  [options.phpUnitPath] - An optional path to the phpunit binary
   */
